...
```
PowerShell -executionpolicy bypass -command "Invoke-WebRequest https://github.com/DesktopECHO/kWSL/raw/master/kWSL.cmd -UseBasicParsing -OutFile kWSL.cmd ; .\kWSL.cmd"
